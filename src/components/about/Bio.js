    ...
    <div className="Bio">
      <div className="Bio__container">
        <span className={loaded ? `animated` : undefined}>
          ...
          <br/> <br/>
          <p>When the opportunity arises, Patricia has been a part of independent productions in varying roles such as: Director of Photography, First Camera Assistant, and Stills Photographer.</p>
          <SocialNav />
        </span>
      </div>
    </div>
